...
// Версия промпта. Поднимается при каждой правке SYSTEM_PROMPT в report.js:
// старые разборы остаются в базе, и по этому числу видно, каким именно
// промптом получен каждый из них.
